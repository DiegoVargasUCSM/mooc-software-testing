...
public class ChocolateBagsTest {
    ...
    @ParameterizedTest(name = "small={0}, big={1}, total={2}, result={3}")
    @CsvSource({"5,3,17,2","4,3,17,2","3,3,17,2","0,3,17,-1","1,3,17,-1","2,3,17,2",
    	"3,3,17,2","0,3,12,-1","1,3,12,-1","2,3,12,2","3,3,12,2"})
    ...
    @ParameterizedTest(name = "small={0}, big={1}, total={2}, result={3}")
    @CsvSource({"4,2,3,3","5,1,4,4","3,5,2,2","3,2,3,3","2,2,3,-1","1,2,3,-1"})
